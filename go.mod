...
require (
	...
	github.com/networkservicemesh/api v1.14.0-rc.5
	github.com/networkservicemesh/sdk v1.14.0-rc.5
	github.com/networkservicemesh/sdk-k8s v0.0.0-20240820090606-8ccf44f03a0c
	github.com/networkservicemesh/sdk-ovs v1.14.0-rc.5
	github.com/networkservicemesh/sdk-sriov v1.14.0-rc.5
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.14.0-rc.5 // indirect
