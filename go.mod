...
require (
	...
	github.com/networkservicemesh/api v1.14.0-rc.2
	github.com/networkservicemesh/sdk v1.14.0-rc.2
	github.com/networkservicemesh/sdk-k8s v1.14.0-rc.2
	github.com/networkservicemesh/sdk-ovs v1.14.0-rc.2
	github.com/networkservicemesh/sdk-sriov v1.14.0-rc.2
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.14.0-rc.2 // indirect
