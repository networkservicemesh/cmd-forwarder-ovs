...
require (
	...
	github.com/networkservicemesh/sdk-k8s v1.7.0-rc.2
	github.com/networkservicemesh/sdk-ovs v1.7.0-rc.2
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.7.0-rc.2 // indirect
