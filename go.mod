...
require (
	...
	github.com/networkservicemesh/sdk-ovs v1.13.1-rc.3
	github.com/networkservicemesh/sdk-sriov v1.13.1-rc.3
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.13.1-rc.3 // indirect
