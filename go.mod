...
require (
	...
	github.com/networkservicemesh/sdk-ovs v0.0.0-20220825020345-9e8fb0ada79a
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20220825014933-e8b76c058df6 // indirect
