...
require (
	...
	github.com/networkservicemesh/api v1.13.3-rc.1
	github.com/networkservicemesh/sdk v1.13.3-rc.1
	github.com/networkservicemesh/sdk-k8s v1.13.3-rc.1
	github.com/networkservicemesh/sdk-ovs v1.13.3-rc.1
	github.com/networkservicemesh/sdk-sriov v1.13.3-rc.1
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.13.3-rc.1 // indirect
