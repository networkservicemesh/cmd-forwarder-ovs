...
require (
	...
	github.com/networkservicemesh/sdk-k8s v1.4.0-rc.1
	github.com/networkservicemesh/sdk-ovs v1.4.0-rc.1
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.4.0-rc.1 // indirect
