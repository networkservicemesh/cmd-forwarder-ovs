...
require (
	...
	github.com/networkservicemesh/sdk-ovs v0.0.0-20231017112013-f18cc35618d7
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20231017110754-253b41ce0fa5 // indirect
